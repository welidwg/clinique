          ...
          <ul class="sidebar-nav">
            ...
            <?php if ($role == 0) { ?>
              ...
              <li class="sidebar-item >" <?php if ($current == "adddept") {
                ...
                <a class="sidebar-link" href="./AddDept.php">
                  <i class="far fa-building  align-middle"></i>
                  <span class="align-middle">Ajouter un departement</span>
                </a>
              </li>
              ...
              <li class="sidebar-item <?php if ($current == "departList") {
                ...
                <a class="sidebar-link" href="./DepartemetList">
                  <i class="fa fa-city align-middle" data-feather=""></i>
                  <span class="align-middle">Liste des departements</span>
                </a>
              </li>
            ...
            <ul class="navbar-nav navbar-align">
              ...
              <li class="nav-item dropdown">
                <a class="nav-icon dropdown-toggle" href="#" id="messagesDropdown" data-bs-toggle="dropdown">
                  <div class="position-relative">
                    <i class="far fa-envelope align-middle" data-feather=""></i>
                  </div>
                </a>
              ...
              <li class="nav-item dropdown">
                ...
                <a class="nav-link dropdown-toggle d-none d-sm-inline-block" href="#" data-bs-toggle="dropdown">
                  <img id="avaTop" src="<?php echo $_SESSION['avatar']; ?>" class="avatar img-fluid rounded me-1" alt="<?php echo $username ?>" />
                  <span id="nomUSR" class="text-dark"><?php echo $nom . " : " . Role($role) ?></span>
                </a>
