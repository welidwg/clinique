                    ...
                    <div class="table-responsive">
                        <table class="table user-list" >
                            ...
                            <tbody id="userTable">
                                ...
                                <tr  class="userData" >
                                    <td>
                                        <img src="<?php if(!empty($array[$k]["Avatar"])){echo $array[$k]['Avatar'];}else{echo "../assets/img/avatars/0.png";}?>" style="border-radius: 50px;" alt="">
                                        <a href="#" class="user-link"><?php echo  $array[$k]["Nom"]."\t"; if($array[$k]["Nom"]==$_SESSION["nom"] ) echo "(Moi)"; ?></a>
                                ...
                                <?php } }else{echo"aucun enregistrement";}?>
